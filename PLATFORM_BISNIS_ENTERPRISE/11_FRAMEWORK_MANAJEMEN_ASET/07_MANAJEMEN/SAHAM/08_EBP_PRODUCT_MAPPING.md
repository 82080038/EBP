# SAHAM - EBP Product Mapping

**Document ID:** ESAMF-SAHAM-008

**Version:** 1.0

**Purpose:** Mapping of SAHAM repository to EBP products

---

# 1. Mapping Overview

This document maps the SAHAM repository components to EBP products, modules, and engines.
...
└── Product Components → Finance ERP (PRODUCTS/FINANCE_ERP)
```
...
```
SAHAM Repository → Restaurant ERP Product
...
```
SAHAM Sales Module → Restaurant ERP Sales Module
...
```
SAHAM Inventory Module → EBP Shared Engine Inventory
...
```
SAHAM Menu Module → Restaurant ERP Menu Module
...
```
SAHAM Kitchen Module → Restaurant ERP Kitchen Module
...
```
SAHAM Table Module → Restaurant ERP Table Module
...
```
SAHAM Reservation Module → Restaurant ERP Reservation Module
...
```
SAHAM Report Module → EBP Shared Engine Reporting
...
```
SAHAM User Module → EBP Core User Management
...
```
SAHAM Settings Module → EBP Core Configuration
...
```
SAHAM → EBP Shared Engine Notification
...
```
SAHAM → EBP Shared Engine Reporting
...
```
SAHAM → EBP Shared Engine Inventory
...
```
SAHAM → EBP Core Authentication API
...
```
SAHAM → Restaurant ERP Sales API
...
```
SAHAM → EBP Shared Engine Inventory API
...
```
SAHAM → EBP Database Configuration
...
```
SAHAM → EBP Shared Engine Dependencies
